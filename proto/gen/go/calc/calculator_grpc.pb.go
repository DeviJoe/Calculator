...
const (
	Calculator_Calc_FullMethodName = "/calc.Calculator/Calc"
)
...
type CalculatorClient interface {
	Calc(ctx context.Context, in *Sentence, opts ...grpc.CallOption) (*Result, error)
}
...
func (c *calculatorClient) Calc(ctx context.Context, in *Sentence, opts ...grpc.CallOption) (*Result, error) {
...
type CalculatorServer interface {
	Calc(context.Context, *Sentence) (*Result, error)
...
func (UnimplementedCalculatorServer) Calc(context.Context, *Sentence) (*Result, error) {
...
func _Calculator_Calc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Calc(ctx, req.(*Sentence))
	}
